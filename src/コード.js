const DIAGNOSIS_STAGES = [
  {
    ...
    questions: [
      question_('digestion-1', 'お通じの頻度とスッキリ感は？', ['毎日快調', '2〜3日に一度', '4日以上出ないことがある', 'ほぼ毎日あるが残便感がある日もある']),
      ...
      question_('digestion-5', '味噌・納豆・漬物など、発酵食品を意識して摂っていますか？', ['毎日2種類以上摂っている', 'ほぼ毎日摂るようにしている', '週に3〜4回程度', 'ほとんど摂らない']),
      question_('digestion-6', '野菜やきのこ、海藻など食物繊維は十分ですか？', ['毎食意識して摂っている', '意識はするが不足しがち', 'ほとんど摂れていない', '肉や加工食品中心である']),
      question_('digestion-7', '肌荒れ、ニキビ、吹き出物など、皮膚のトラブルは気になりますか？', ['全く気にならない', 'たまに気になる', '季節の変わり目に気になる', '慢性的に常に気になる']),
      question_('digestion-8', '日中の集中力や気分が落ち込みやすいと感じますか？', ['常にポジティブで集中できる', 'たまに気分が落ちたり、疲れを感じる', '慢性的に疲労感やだるさを感じる', '何事にもやる気が出ない']),
      question_('digestion-9', '健康診断の結果や、体型の変化への関心度は？', ['常に数値を意識し、キープしている', '気にはなるが、特に何もしていない', '頑張っているが、毎年少しずつ悪くなっている', '何から改善していいか分からない']),
  ...
  },
  {
    ...
    questions: [
      ...
      question_('deep-health-14', 'ほぼ毎日、冷たい飲み物（アイスコーヒー、ジュース等）を飲んでいますか？', ['ほとんど温かいものを飲む', '季節などにより、たまに飲む', '1日に1度は必ず冷たいものを飲む', '季節を問わず、冷たい飲み物が手放せない']),
      ...
      question_('deep-health-19', '麹や発酵食品を使った「料理法」や「作り方」に関心がありますか？', ['自分で作り、深く学びたい', '興味はあるが、作り方は知らない', '料理はするが、作り方には興味ない', 'あまり興味がない']),
